...
export function SessionMetrics({
  ...
  if (countdownLabel) {
    return (
      <div className="flex flex-col items-end">
        <span className="text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-3xl uppercase tracking-wide text-neutral-300">
          Starts in
        </span>
        <span
          className={`text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl 3xl:text-5xl 4xl:text-5xl 5xl:text-5xl font-bold ${countdownClass}`}
        >
          {countdownLabel}
        </span>
      </div>
