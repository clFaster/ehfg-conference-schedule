...
export default function SpeakerCard({ speaker }: SpeakerCardProps) {
  return (
    <div className="flex items-center space-x-2 sm:space-x-3 w-full bg-white/5 rounded-md sm:rounded-lg p-1.5 sm:p-2 md:p-3 lg:p-4 xl:p-5 2xl:p-6 3xl:p-7 4xl:p-8 5xl:p-10 border border-white/10">
      {speaker.image ? (
