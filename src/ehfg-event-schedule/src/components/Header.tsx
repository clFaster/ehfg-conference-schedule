  ...
  return (
    <header className="w-full px-20 pt-12 pb-8 flex flex-col xl:flex-row items-center xl:items-end justify-between gap-10">
      <div className="flex flex-col items-center xl:items-start">
        <h1 className="text-5xl 2xl:text-[4.5rem] font-black tracking-tight bg-gradient-to-br from-green-400 via-blue-400 to-purple-400 bg-clip-text text-transparent bg-200 animate-gradientShift drop-shadow-md text-center xl:text-left uppercase">
          Live Schedule
        </h1>
