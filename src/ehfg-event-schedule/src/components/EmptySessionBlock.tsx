...
export default function EmptySessionBlock({ variant }: EmptySessionBlockProps) {
  ...
  if (isCurrent) {
    return (
      <div className="3xl:text-2xl 4xl:text-3xl 5xl:text-3xl rounded-2xl p-10bg-white/15 saturate-[180%] md:saturate-[130%] sm:saturate-[120%] brightness-[120%] bg-gradient-to-br from-white/25 to-white/15 shadow-[0_16px_40px_rgba(0,0,0,0.6),0_4px_12px_rgba(0,0,0,0.4)] text-neutral-200 h-[320px] flex items-center justify-center text-center text-2xl font-semibold">
